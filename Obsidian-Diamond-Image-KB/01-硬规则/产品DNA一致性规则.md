...
- wearing_area：佩戴部位
- silhouette：产品整体轮廓
- visual_scale_lock：产品在三张图中的视觉大小级别，只允许 subtle / medium visible / statement but natural
...
- 全身图和半身图可以自然露出产品，不硬广。
- 全身图和半身图中，主产品可以自然可见，但不能被刻意摆到镜头前。
- 全身图和半身图中，主产品不应成为画面主要视觉中心或人物动作目的。
- 全身图和半身图中，主产品应像真实随拍里的自然细节：可被注意到，但不被展示出来。
- 特写图必须清楚展示产品结构。
- 不为了产品一致性把人物和场景也写死。
