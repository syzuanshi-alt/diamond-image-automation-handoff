...
- No persona/scene/action/lens repeats within the 5-set window.

## V3 Fixes

- Scene selection now avoids repeats within the recent 5-set window.
- Macro prompt includes full Product DNA.
